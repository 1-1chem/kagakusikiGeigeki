...
// レベルごとの説明文リスト（複数のスライド）
        const levelDescriptions = {
            ...
            2: [
                "原子番号21～36番の元素記号が襲来<br>中学の知識では撃墜できない<br>高校での実力を発揮せよ<br>この画面で20秒以上留まると，Lifeがひとつ減るぞ<br>準備ができたら開始ボタンを押せ！"
            ],
            3: [
                "原子番号38番以降の元素記号が襲来<br>勉強していないと全問撃墜は不能<br>この画面で20秒以上留まると，Lifeがひとつ減るぞ<br>準備ができたら開始ボタンを押せ！"
            ],
            4: [
                "今度はイオン式，入力大変だぞ<br>文字を入力して上付ボタンを押すと<br>直前の1文字だけ上付きになる<br>この画面で20秒以上留まると，Lifeがひとつ減るぞ<br>準備ができたら開始ボタンを押せ！"
            ],
            5: [
                "難しいぞ！元素記号右上の数字暗記は？<br>原子番号24番以降のイオン式<br>文字を入力して上付ボタンを押すと<br>直前の1文字だけ上付きになる<br>この画面で20秒以上留まると，Lifeがひとつ減るぞ<br>準備ができたら開始ボタンを押せ！"
            ],
            6: [
                "よくぞここまで来た<br>多原子イオンがついに降臨<br>今度は下付もあるぞ<br>この画面で20秒以上留まると，Lifeがひとつ減るぞ<br>準備ができたら開始ボタンを押せ！"
            ]
        };
